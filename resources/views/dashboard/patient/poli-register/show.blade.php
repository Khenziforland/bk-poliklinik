            ...
            <div class="card-body">
                ...
                <div class="mb-1">
                    ...
                    <input type="text" class="form-control" name="poliName" id="poliName"
                        value="{{ $poliRegister->patient->medical_record_number }}" placeholder="Masukan Nama Poli" autocomplete="off"
                        readonly>
                </div>
                ...
                <div class="mb-1">
                    ...
                    <input type="text" class="form-control" name="poliName" id="poliName"
                        value="{{ $checkupSchedule->start_time }} - {{ $checkupSchedule->end_time }}" placeholder="Masukan Nama Poli" autocomplete="off"
                        readonly>
                </div>
                ...
                <div class="mb-1">
                    ...
                    <input type="text" class="form-control" name="poliName" id="poliName"
                        value="{{ $poliRegister->status }}" placeholder="Masukan Nama Poli" autocomplete="off"
                        readonly>
                </div>
            </div>
        </div>
